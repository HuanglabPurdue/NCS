%------ Demo code for noise correction algorithm for sCMOS camera (NCS algorithm) on simulated data, bead------------
...
beadN = 10;         % number of beads in the image
...
idealimgnorm = genidealimage_bead(imgsz,beadN,Pixelsize,SRzoom,NA,Lambda);
...
I = 200;             % total photon count of each emitter on simulated microtubules
