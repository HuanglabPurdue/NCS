...
def loadNCSCLibrary():
    ...
    #
    # This assumes that the C libraries are in this directory.
    #
    ...
    if (sys.platform == "win32"):
        ...
        # of FFTW or LBFGS these will get loaded instead of the ones in 
        # clib/pyCNCS.
        try:
            ...
            # Push the clib/pyCNCS directory into the DLL search path.
